...
public class OrderServiceImplTest {
    ...
    void setUp() {
        ...
        Order order1 = new Order("13652556-012a-4c07-b536-54eb1396d79b",
                products, 170856000L, "Safira Sudrajat");
        orders.add(order1);
        Order order2 = new Order("719e15bb-4b15-42f4-aebc-c3af385fb078",
    ...
    void testUpdateStatus() {
        Order order = orders.get(1);
        Order newOrder = new Order(order.getId(), order.getProducts(), order.getOrderTime().longValue(),
